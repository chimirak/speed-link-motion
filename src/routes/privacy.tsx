      ...
      <Section>
        <Prose>
          <p>
            ...
            the data controller for personal data processed through this website and our booking
          ...
          <ul>
            ...
            <li>Consignment details: collection and delivery addresses, contents description, weight and dimensions.</li>
            <li>Delivery evidence: signatures, timestamps and delivery location data.</li>
            <li>Technical data: IP address, device type and pages visited, used only to keep the site secure and working.</li>
          </ul>

          <h2>Why we process it</h2>
          <p>
            To perform the contract of carriage, to keep you informed of a consignment's progress,
            to meet customs and transport legal obligations, and to answer enquiries you send us.
          ...
          <p>
            ...
            to or restrict processing. Email{" "}
            <strong>Speedlinkcourier6@gmail.com</strong> and we will respond within 30 days. You

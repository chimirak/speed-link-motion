    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border p-4">
        <div className="min-w-0">
          <p className="font-medium">Need an answer right now?</p>
          <p className="text-sm text-muted-foreground">
            Message a coordinator on WhatsApp — {WHATSAPP_DISPLAY}
          </p>
        </div>
        <Button asChild variant="speed" size="sm">
          <a href={whatsappUrl(WHATSAPP_DEFAULT_MESSAGE)} target="_blank" rel="noopener noreferrer">

...
export const hubs: Hub[] = [
  {
    ...
    lon: -0.77,
    lat: 51.28,
    detail: "Global HQ · 24/7 control room",
  },
  {
    name: "Amsterdam",
    region: "Europe",
    lon: 4.9,
    lat: 52.37,
    detail: "European road & air gateway",
  },
  {
    name: "New York",
    ...
    lon: -74.0,
    lat: 40.71,
    detail: "Transatlantic express hub",
  },
  {
    name: "Dubai",
    region: "Middle East",
    lon: 55.27,
    lat: 25.2,
    detail: "Middle East consolidation",
  },
  {
    name: "Singapore",
    region: "Asia Pacific",
    lon: 103.82,
    lat: 1.35,
    detail: "APAC distribution centre",
  },
  {
    name: "Hong Kong",
    region: "Asia Pacific",
